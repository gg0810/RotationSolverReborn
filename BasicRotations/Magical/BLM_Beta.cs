...
[Rotation("Pending Rework", CombatType.PvE, GameVersion = "7.2")] [SourceCode(Path = "main/BasicRotations/Magical/BLM_Beta.cs")] [Api(4)]

public sealed class BLM_Beta : BlackMageRotation { #region Config Options [RotationConfig(CombatType.PvE, Name = "Use Infinite Paradox Rotation when at level 100)")] public bool Infinity { get; set; } = false;
